...
-- ============================================================
-- VISTA: identity_audit.vw_logs_recientes
...
-- ============================================================
CREATE OR REPLACE VIEW identity_audit.vw_logs_recientes AS
SELECT
  al.id_audit_log,
  al.id_user,
  u.name          AS user_name,
...
COMMENT ON VIEW identity_audit.vw_logs_recientes
...
-- ============================================================
-- VISTA: identity_audit.vw_resumen_por_modulo
...
-- ============================================================
-- VISTA: identity_audit.vw_eventos_fallidos
...
-- ============================================================
CREATE OR REPLACE VIEW identity_audit.vw_eventos_fallidos AS
SELECT
  al.id_audit_log,
  al.id_user,
  u.name          AS user_name,
...
-- ============================================================
-- VISTA: identity_audit.vw_actividad_por_usuario
...
-- ============================================================
-- VISTA: identity_audit.vw_logs_inicio_cierre_sesion
...
-- ============================================================
CREATE OR REPLACE VIEW identity_audit.vw_logs_inicio_cierre_sesion AS
SELECT
  al.id_audit_log,
  al.id_user,
  u.name          AS user_name,
